...
{
    /**
     * Sekreter mesajını işler ve gerekli istatistikleri toplayarak prompt oluşturur.
     */
    /**
     * Sekreter mesajını işler ve gerekli istatistikleri toplayarak prompt oluşturur.
     */
    ...
    protected function getSystemPrompt(string $role, object $user): string
    {
        ...
        // --- B. PROMPT OLUŞTURMA ---
        return "Sen İkihece OTS'nin 'Pusula' adındaki yönetici asistanısın (Sekreter Modu).
        Şu an kurumun idari işlerinden sorumlu bir personel ile konuşuyorsun.
        ...
        3. **ÜSLUP:**
           - Net, profesyonel ve sonuç odaklı ol.
           ...
           - Öğrenci konumu istendiğinde, eğer sistemde kayıtlı bir konum linki varsa bunu mutlaka paylaş.
        ";
    }
