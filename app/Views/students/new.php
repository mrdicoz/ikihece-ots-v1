        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="studentTabContent">
                    ...
                    <div class="tab-pane fade" id="saglik" role="tabpanel"><?= $this->include('students/_form_saglik') ?></div>
                    <div class="tab-pane fade" id="adres" role="tabpanel"><?= $this->include('students/_form_adres') ?></div>
                    <div class="tab-pane fade" id="diger" role="tabpanel"><?= $this->include('students/_form_diger') ?></div>
                </div>
            </div>
            <div class="card-footer text-end">
                <a href="<?= site_url('students') ?>" class="btn btn-secondary">İptal</a>
                <button type="submit" class="btn btn-success">Öğrenciyi Oluştur</button>
            </div>
        </div>
    </form>
</div>
