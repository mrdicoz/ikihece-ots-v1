...
<?= $this->section('main') ?>
<form method="post" id="templateForm" action="<?= base_url('documents/templates/create') ?>">
    <?= csrf_field() ?>
    ...
    <div class="container-fluid py-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Örn: İşe Giriş Bildirimi" value="<?= old('name') ?>" required>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="description" class="form-control" placeholder="Bu şablonun ne için kullanıldığına dair kısa bir açıklama..." value="<?= old('description') ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 mb-4">
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <textarea name="content" id="tinymceEditor" class="form-control"><?= old('content') ?></textarea>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow mb-3">
            ...
            <div class="card-body"><div class="row">
                <div class="col-md-4"><div class="form-check form-switch"><input type="checkbox" name="has_number" value="1" class="form-check-input" id="hasNumber" checked><label class="form-check-label" for="hasNumber">Bu belgede evrak numarası olsun</label></div></div>
                <div class="col-md-4" id="customNumberDiv"><div class="form-check form-switch"><input type="checkbox" name="allow_custom_number" value="1" class="form-check-input" id="allowCustom"><label class="form-check-label" for="allowCustom">Esnek Numara</label></div></div>
                <div class="col-md-4" id="fillGapsDiv"><div class="form-check form-switch"><input type="checkbox" name="fill_gaps" value="1" class="form-check-input" id="fillGaps" checked><label class="form-check-label" for="fillGaps">Boşlukları Doldur</label></div></div>
            </div></div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card border-0 shadow-sm">
                    <div class="card-body d-flex justify-content-between">
                        ...
                        <div>
                            ...
                            <button type="submit" class="btn btn-success"><i class="bi bi-check-circle me-2"></i>Şablonu Kaydet</button>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Event Listeners bölümüne (document.getElementById('previewBtn')... satırından ÖNCE) EKLE:
...
function renderFieldsTable() {
    ...
    // prepareFormForSubmit fonksiyonunu ŞU ŞEKİLDE GÜNCELLE:

    function prepareFormForSubmit(e) {
        tinymce.triggerSave();
        
        // TinyMCE içeriği boş mu kontrol et
