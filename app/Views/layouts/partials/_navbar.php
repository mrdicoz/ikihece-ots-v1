...
$avatar = base_url('assets/images/user.jpg');
$username = auth()->user()->username ?? 'Misafir'; // Shield hazır olunca bu çalışacak
?>
<nav class="navbar navbar-expand-lg bg-body-tertiary shadow fixed-top">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="<?= site_url('admin/students/import') ?>"><i class="bi bi-file-earmark-bar-graph"></i> İçe Aktar</a></li>
            </ul>
    </li>
<?php endif; ?>
            </ul>
            <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="me-2 d-none d-xl-inline fw-bold"><?= auth()->user()->username ?></span>
            ...
            <ul class="navbar-nav d-lg-none w-100 mt-3 border-top pt-3">
                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?= $avatar ?>" alt="Kullanıcı Profili" class="rounded-circle" height="32" width="32" style="object-fit: cover;">
                        <span class="fw-bold ms-1"><?= auth()->user()->username ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="<?= site_url('profile') ?>">Profilim</a></li>
                        <li><hr class="dropdown-divider"></li>
